...
class AccountingInvoiceServiceTest(TestCase):
    ...
    def setUp(self):
        ...
        self.invoice1 = InvoiceModelFactory.build_invoice(number="F2023/01", date=datetime(2023, 1, 15).date(), supplier="Telefónica")
        self.invoice2 = InvoiceModelFactory.build_invoice(number="F2023/02", date=datetime(2023, 1, 20).date(), supplier="Telefónica")
        self.invoice3 = InvoiceModelFactory.build_invoice(number="F2023/03", date=datetime(2023, 2, 10).date(), supplier="Telefónica")
        self.invoice4 = InvoiceModelFactory.build_invoice(number="F2023/04", date=datetime(2023, 1, 15).date(), supplier="Vodafone")
